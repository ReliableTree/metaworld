from LanguagePolicies.utils.Transformer import TransformerModel, TailorTransformer, NNSetup
import torch
...
class CriticSetup:
    def __init__(self) -> None:
        self.nn = NNSetup()
        self.nn.use_layernorm = False
        self.nn.upconv = False
        self.nn.num_upconvs = 4
        self.nn.stride = 3
        self.nn.d_output = 5
        self.nn.d_model = 60
        self.nn.nhead = 6
        ...
        self.model_class: TailorTransformer
        self.lr = None
...
class ActorSetup:
    def __init__(self) -> None:
        ...
        self.model_class: TransformerModel
        self.lr = None
        self.optimizer_kwargs = {}

class NetworkSetup:
    def __init__(self) -> None:
        self.actor_setup = ActorSetup
        self.critic_setup = CriticSetup
...
class ActiveCriticArgs:
    ...
    def set_critic_optimisation_threshold(self, optimisation_threshold: float):
    ...
    def set_meta_optimizer_lr(self, mo_lr: float):
        self.network_setup.critic_setup.lr = mo_lr

    def set_lr(self, lr: float):
        self.network_setup.actor_setup.lr = lr
